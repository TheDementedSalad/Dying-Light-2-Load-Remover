...
{ 
	...
	current.Options == 3 || current.Paused == 1 && current.Options2 != 5 && current.Options2 != 4 && current.Paused2 != 0 ||
	current.Paused == 2 && current.Paused3 == 2 || current.Options2 == 3 && current.Options == 1) && current.onlineState == 0 || 
