...
{ 
	...
	byte Paused: "engine_x64_rwdi.dll", 0x21E3A80, 0x880;
...
isLoading 
{ 
	return current.Loading == 2 || current.menuCutsStart == 200 || current.Inv != 63 && current.Paused == 8 && current.onlineState == 0 || current.blackscreenNew != 158;
}
