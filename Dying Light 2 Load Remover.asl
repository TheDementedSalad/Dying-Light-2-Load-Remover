...
{ 
	...
	byte Exit: "engine_x64_rwdi.dll", 0x21E3A80, 0x1E8, 0x6DA;
} 
...
isLoading 
{ 
	return current.Loading == 2 || current.menuCutsStart == 200 || (current.Exit == 1 && current.Paused == 2 || current.Exit == 1 && current.Paused == 3) && current.onlineState == 0 || current.blackscreenNew != 158;
}
